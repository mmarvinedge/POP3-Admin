...
import com.metremobbi.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.metremobbi.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.metremobbi.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.metremobbi.infra.model.SortOrder.DESCENDING
                            : com.metremobbi.infra.model.SortOrder.UNSORTED;
                }
